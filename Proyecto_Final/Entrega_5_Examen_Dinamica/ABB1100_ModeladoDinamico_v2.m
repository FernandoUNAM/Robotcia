...
fid = fopen("Me_P2_v2.m","wt");
fprintf(fid,"%s\n",char(Me));
fclose(fid);

fid = fopen("Ge_P2_v2.m","wt");
fprintf(fid,"%s\n",char(Ge));
fclose(fid);

fid = fopen("Ce_P2_v2.m","wt");
fprintf(fid,"%s\n",char(Ce));
fclose(fid);

fid = fopen("Fe_P2_v2.m","wt");
fprintf(fid,"%s\n",char(Fe));
fclose(fid);
...
filename = 'Fe_P2_v2.m';
s_filename = 'Fe_P2_v2_s.m';
ss_filename = 'Fe_P2_v2_ss.m';
sss_filename = 'Fe_P2_v2_sss.m';
ssss_filename = 'Fe_P2_v2_ssss.m';
...
filename = 'Ge_P2_v2.m';
s_filename = 'Ge_P2_v2_s.m';
ss_filename = 'Ge_P2_v2_ss.m';
sss_filename = 'Ge_P2_v2_sss.m';
ssss_filename = 'Ge_P2_v2_ssss.m';
...
filename = 'Me_P2_v2.m';
s_filename = 'Me_P2_v2_s.m';
ss_filename = 'Me_P2_v2_ss.m';
sss_filename = 'Me_P2_v2_sss.m';
ssss_filename = 'Me_P2_v2_ssss.m';
...
filename = 'Ce_P2_v2.m';
s_filename = 'Ce_P2_v2_s.m';
ss_filename = 'Ce_P2_v2_ss.m';
sss_filename = 'Ce_P2_v2_sss.m';
ssss_filename = 'Ce_P2_v2_ssss.m';
