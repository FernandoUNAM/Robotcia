...
fid = fopen("Me_P2_v4.m","wt");
fprintf(fid,"%s\n",char(Me));
fclose(fid);

fid = fopen("Ge_P2_v4.m","wt");
fprintf(fid,"%s\n",char(Ge));
fclose(fid);

fid = fopen("Ce_P2_v4.m","wt");
fprintf(fid,"%s\n",char(Ce));
fclose(fid);

fid = fopen("Fe_P2_v4.m","wt");
fprintf(fid,"%s\n",char(Fe));
fclose(fid);

save("DinamicaDirecta_v4.mat","Fext","Fe","J07","Me","Ge","Ce","Fe","M","G","C","-mat")

%% Exterior Force
clc; 

filename = 'Fe_P2_v4.m';
s_filename = 'Fe_P2_v4_s.m';
ss_filename = 'Fe_P2_v4_ss.m';
sss_filename = 'Fe_P2_v4_sss.m';
ssss_filename = 'Fe_P2_v4_ssss.m';
...
filename = 'Ge_P2_v4.m';
s_filename = 'Ge_P2_v4_s.m';
ss_filename = 'Ge_P2_v4_ss.m';
sss_filename = 'Ge_P2_v4_sss.m';
ssss_filename = 'Ge_P2_v4_ssss.m';
...
filename = 'Me_P2_v4.m';
s_filename = 'Me_P2_v4_s.m';
ss_filename = 'Me_P2_v4_ss.m';
sss_filename = 'Me_P2_v4_sss.m';
ssss_filename = 'Me_P2_v4_ssss.m';
...
filename = 'Ce_P2_v4.m';
s_filename = 'Ce_P2_v4_s.m';
ss_filename = 'Ce_P2_v4_ss.m';
sss_filename = 'Ce_P2_v4_sss.m';
ssss_filename = 'Ce_P2_v4_ssss.m';
